...
;=======================================================
	...
	RegisterHotkey("a","<cm_SelectCurrentExtension>","TTOTAL_CMD")
	RegisterHotkey("A","<cm_SelectCurrentName>","TTOTAL_CMD")
	RegisterHotkey("}","<cm_UnSelectCurrentExtension>","TTOTAL_CMD")
	RegisterHotkey("b","<cm_ClearAll>","TTOTAL_CMD")
	RegisterHotkey("B","<cm_ExchangeSelection>","TTOTAL_CMD")
